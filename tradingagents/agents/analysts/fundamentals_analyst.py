...
async def create_fundamentals_analyst(llm, mcp_client, search_tool):
    async def fundamentals_analyst_node(state):
        ...
        system_message = (
            """您是一位研究员,负责分析过去一个月左右某公司的基本面信息。
            请撰写一份全面的公司基本面信息报告, 包括财务文件、公司简介、基本财务数据、公司财务历史、内部人士情绪和内部交易等,
            以全面了解公司的基本面信息,为交易者提供参考。
            请务必尽可能详细。不要简单地说趋势好坏参半,而是要提供详细和细致的分析见解,帮助交易者做出决策。
            请以公司的基本面数据为主，并且做中长期的分析。
